...
const productDatabase = [
  ...
  },
  {
    ...
    description: 'Convertible laptop with 4K touchscreen, Intel i7 processor, 16GB RAM',
    price: 1499,
    category: 'Laptops',
    rating: 4.3,
    reviewCount: 45,
  ...
  },
  {
    ...
    description: 'Tensor G3 chip, 120Hz display, 512GB storage, advanced AI features',
    price: 799,
    category: 'Smartphones',
    rating: 4.5,
    reviewCount: 78,
    ...
    specifications: [
      ...
      { label: 'Storage', value: '512GB' },
      { label: 'Display', value: '6.7" Super Actua Display' },
      { label: 'Refresh Rate', value: '120Hz LTPO' },
      { label: 'Camera', value: '50MP + 48MP + 48MP' },
      { label: 'Battery', value: '5050mAh with 30W fast charging' },
    ],
    features: [
      'Tensor G3 chip with AI capabilities',
      'Best Take for perfect group photos',
      'Magic Editor for photo enhancements',
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: 'Connectivity', value: 'Bluetooth 5.3, H2 chip' },
  ...
  },
  {
    ...
    description: 'Business laptop with Intel i7, 16GB RAM, 512GB SSD, military-grade durability',
    price: 1699,
    category: 'Laptops',
    rating: 4.4,
    reviewCount: 63,
    ...
    specifications: [
      ...
      { label: 'Weight', value: '1.12 kg (2.48 pounds)' },
    ...
    features: [
      ...
      'PrivacyGuard display for anti-shoulder surfing',
      'Human Presence Detection with lock/unlock',
  ...
  },
  {
    id: '11',
    name: 'OnePlus 12',
    description: 'Snapdragon 8 Gen 3, 256GB storage, 120Hz LTPO display, 100W fast charging',
    price: 699,
    category: 'Smartphones',
    rating: 4.5,
    reviewCount: 71,
    ...
    features: [
      ...
      'Aqua Touch display for wet finger operation',
      'Alert Slider for quick sound profiles',
  ...
  },
  {
    ...
    description: 'Advanced health tracking, GPS, LTE option, sleep coaching, body composition',
    price: 329,
    category: 'Accessories',
    rating: 4.3,
    reviewCount: 94,
    images: [
      'https://images.unsplash.com/photo-1579586337278-3f4b9c5b5b1a',
      'https://images.unsplash.com/photo-1579586337278-3f4b9c5b5b1a?auto=format&fit=crop&w=800&q=80',
    ],
    specifications: [
      { label: 'Display', value: '1.5" Super AMOLED' },
      { label: 'Battery Life', value: 'Up to 40 hours' },
      { label: 'Health Sensors', value: 'BioActive Sensor (Optical HR, ECG, BIA)' },
      { label: 'Connectivity', value: 'Bluetooth, Wi-Fi, LTE optional' },
      { label: 'Water Resistance', value: '5ATM + IP68' },
      { label: 'Compatibility', value: 'Android and iOS' },
    ],
    features: [
      'Body Composition analysis',
      'Sleep coaching with sleep score',
      'Advanced workout tracking with 95+ exercises',
